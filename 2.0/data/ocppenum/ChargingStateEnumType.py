Charging
The contactor of the Connector is closed and energy is flowing between EVSE and EV.
EVConnected
There is a connection between EV and EVSE, in case the protocol used between EV and the Charging Station can detect a connection. The connection can either be wired or wireless.
SuspendedEV
